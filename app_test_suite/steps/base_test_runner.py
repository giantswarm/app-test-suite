...
class BaseTestRunner(BuildStep, ABC):
    ...
    _min_apptestctl_version = "0.11.1"
    ...
    def _ensure_app_platform_ready(self, kube_config_path: str, github_token: str) -> None:
        """
    ...
    def run(self, config: argparse.Namespace, context: Context) -> None:
        ...
        self._ensure_app_platform_ready(self._cluster_info.kube_config_path, config.github_token)
